/* ===================================================================
   GDC - Gestore della Crisi — Area Clienti — Configurazione
   =================================================================== */

const CONFIG = {
    // URL del Google Apps Script Web App (da aggiornare dopo il deploy)
    API_URL: 'https://script.google.com/macros/s/AKfycbwnSf9ke76ZwIK1U2sQ1pjuscFKpPacSgusbkep1m6ZUxK5WHK8SZGkBOyeOh2TLhDeXw/exec',

    // Dimensione massima file (25MB)
    MAX_FILE_SIZE: 25 * 1024 * 1024,

    // Estensioni file consentite (gestite anche lato server)
    ALLOWED_EXTENSIONS: ['pdf', 'doc', 'docx', 'csv', 'xls', 'xlsx', 'jpg', 'jpeg', 'png'],

    // Categorie documenti — Crisi d'Impresa
    CATEGORIES: [
        { id: 'bilanci', label: 'Bilanci', icon: 'bar-chart-3', folder: 'Bilanci' },
        { id: 'situazione_debitoria', label: 'Situazione Debitoria', icon: 'trending-down', folder: 'Situazione debitoria' },
        { id: 'estratti_conto', label: 'Estratti Conto', icon: 'landmark', folder: 'Estratti conto' },
        { id: 'contratti_accordi', label: 'Contratti e Accordi', icon: 'handshake', folder: 'Contratti e accordi' },
        { id: 'documentazione_fiscale', label: 'Doc. Fiscale', icon: 'receipt', folder: 'Documentazione fiscale' },
        { id: 'visure_certificati', label: 'Visure e Certificati', icon: 'file-badge', folder: 'Visure e certificati' },
        { id: 'atti_legali', label: 'Atti Legali', icon: 'scale', folder: 'Atti legali' },
        { id: 'corrispondenza', label: 'Corrispondenza', icon: 'mail', folder: 'Corrispondenza' },
        { id: 'altro', label: 'Altro', icon: 'folder-plus', folder: 'Altro' }
    ],
    ...
    SESSION_KEY: 'gdc_session',

    // URL del sito principale (per il link "Torna al sito")
    SITE_URL: 'https://www.gestoredellacrisi.it/',
