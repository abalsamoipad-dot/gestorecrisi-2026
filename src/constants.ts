...
export const EXPERTISE_DATA = [
  ...
  },
  {
    ...
    description: 'Piani strategici per preservare il valore dell\u2019impresa e garantire la prosecuzione dell\u2019attività attraverso strumenti di composizione e protezione.',
  },
];
